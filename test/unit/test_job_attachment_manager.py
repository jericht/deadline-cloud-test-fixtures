...
from bealine_test_scaffolding import JobAttachmentManager
...
class TestJobAttachmentManager:
    ...
    def setup_test(self, mock_get_bealine_models, boto_config):
        with mock.patch("bealine_test_scaffolding.job_attachment_manager.BealineManager"):
    ...
    @mock.patch(
        "bealine_test_scaffolding.job_attachment_manager." "JobAttachmentManager.cleanup_resources"
    )
    def test_deploy_resources_client_error(
        ...
        with mock.patch.object(
            self.job_attachment_manager.bealine_manager,
            "create_kms_key",
    ...
    @mock.patch(
        "bealine_test_scaffolding.job_attachment_manager." "JobAttachmentManager._create_stack"
    )
    ...
    def test_cleanup_resources(self):
        ...
        """
        self.job_attachment_manager.bealine_manager.farm_id = "farm-asdf"
        self.job_attachment_manager.bealine_manager.kms_key_metadata = {"key_id": "aasdfkj"}
        self.job_attachment_manager.bealine_manager.queue_id = "queue-asdfji"
        ...
        self.job_attachment_manager.bealine_manager.delete_farm.assert_called_once()  # type: ignore[attr-defined] # noqa
        self.job_attachment_manager.bealine_manager.delete_kms_key.assert_called_once()  # type: ignore[attr-defined] # noqa
        self.job_attachment_manager.bealine_manager.delete_queue.assert_called_once()  # type: ignore[attr-defined] # noqa
    ...
    def test_cleanup_resources_no_resource_exist(self):
        ...
        self.job_attachment_manager.bealine_manager.create_farm.assert_not_called()  # type: ignore[attr-defined] # noqa
        self.job_attachment_manager.bealine_manager.create_kms_key.assert_not_called()  # type: ignore[attr-defined] # noqa
        self.job_attachment_manager.bealine_manager.create_queue.assert_not_called()  # type: ignore[attr-defined] # noqa
